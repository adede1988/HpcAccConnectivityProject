...
#SBATCH --job-name="PM2\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=PM2.%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=PM2.%a.err 
...
matlab -singleCompThread -batch "start=${SLURM_ARRAY_TASK_ID}; PCCstatsWrapper2;"
