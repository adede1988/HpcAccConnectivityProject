...
#SBATCH --array=1-24 ## number of jobs to run "in parallel" 
...
#SBATCH --mem-per-cpu=16G ## how much RAM do you need per CPU (this affects your FairShare score so be careful to not ask for more than you need))
...
matlab -singleCompThread -batch "start=${SLURM_ARRAY_TASK_ID}; HFBLeadLagPipelineWrapper;"
