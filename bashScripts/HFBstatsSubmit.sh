...
#SBATCH --job-name="HFB\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=HFB.%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=HFB.%a.err 
...
matlab -singleCompThread -batch "start=${SLURM_ARRAY_TASK_ID}; HFBsingleTrialWrapper;"
