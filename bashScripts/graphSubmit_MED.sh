...
#SBATCH --array=1-1512 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="med\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=med.%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=med.%a.err 
