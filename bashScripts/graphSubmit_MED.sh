...
#SBATCH --array=1-1473 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="med2\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=med2.%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=med2.%a.err 
...
matlab -singleCompThread -batch "start=${SLURM_ARRAY_TASK_ID}; targLen = 'MED'; targType = 'HFB'; graphWrapper;"
