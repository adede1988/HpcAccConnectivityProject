...
timeSet_colors <- c("HFB" = '#068a9c', "image" = '#770f10')  # For boxplots
...
outPlot <- ggplot(filter(long_df, encRet==er), aes(y = Saturation, x = hitMiss, fill = hitMiss)) +
 ...
 png(paste( "R:\\MSS\\Johnson_Lab\\dtf8829\\publicationFigureData\\pubFigs\\" ,
  ...
  scale_color_manual(values=tsColors, name = "memory") +
  scale_fill_manual(values=tsColors, name = "memory") +
  theme_bw() +
  ylim(c(0, 50)) + 
  theme(legend.position = 'none', 
        panel.border = element_blank(),
